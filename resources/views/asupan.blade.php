                ...
                <div class="container mx-auto px-8 sm:flex sm:flex-wrap sm:gap-5 sm:justify-evenly">
                    <div class="flex flex-wrap">
                        ...
                        <div class="relative mb-10 w-2/5">
                            <img src="{{ asset('storage/' . $asupan->image_cover) }}" alt="{{ $asupan->name }}" class="mb-4">
                        </div>
                        @else
                        ...
                        @endif
                        <div class="relative">
                            <iframe class="mt-4" width="580" height="430" src="https://www.youtube.com/embed/{{ $asupan->youtube_id }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
                    <div class="border rounded-lg shadow-lg px-8 py-8 relative mb-10 sm:w-1/2">
                        <h2><b>Rekomendasi asupan :</b> {{ $asupan->title }}</h2>
                        <h3><b>Deskripsi :</b></h3>
                        <p class="text-left lg:text-sm">{!! $asupan->deskripsi_gizi !!}</p>
                    </div>
                </div>
            </div>
